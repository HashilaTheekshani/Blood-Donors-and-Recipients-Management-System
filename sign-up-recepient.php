...
$status=1;
    ...
    $ret="select EmailId from tblbloodrecipients where EmailId=:email";
...
if($query -> rowCount() == 0)
{
$sql="INSERT INTO  tblbloodrecipients(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,status,Password) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status,:password)";
...
<body>
	...
	<div class="breadcrumb-agile">
		<div aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Signup Recepients</li>
			</ol>
		</div>
	</div>
	<!-- //page details -->
 ...
 <div class="login px-4 mx-auto mw-100">
                            <h5 class="text-center mb-4">Register Now<br>Recepients</h5>
...
<option value="Female">Female</option>
                                ...
                                <div class="form-group">
                                    <label class="mb-2">Blood Group required</label>
