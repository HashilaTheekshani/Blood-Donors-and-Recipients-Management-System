...
if (strlen($_SESSION['bbdmsdid']==0)) {
 ...
 if(isset($_POST['update']))
  ...
  $sql="update tblbloodrecipients set FullName=:name,MobileNumber=:mno, Age=:age,Gender=:gender,BloodGroup=:bloodgroup,Address=:address,Message=:message  where id=:uid";
...
<head>
	<title>Blood Bank Donar Management System !! Recepient profile</title>
		...
		<div aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item">
					<a href="index-recepient.php">Home</a>
				</li>
				<li class="breadcrumb-item active" aria-current="page">Recepient  Profile</li>
			</ol>
		</div>
	</div>
	<!-- //page details -->
	...
	<div class="appointment py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Recepient  Profile</h3>
				<span>
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form">
					...
					<form action="#" method="post">
						<?php
$uid=$_SESSION['bbdmsdid'];
$sql="SELECT * from  tblbloodrecipients where id=:uid";
$query = $dbh -> prepare($sql);
$query->bindParam(':uid',$uid,PDO::PARAM_STR);
$query->execute();
